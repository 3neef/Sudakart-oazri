...
@section('title',  __('adminNav.wallet_report'))
@section('content')
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                        <li class="nav-item"><a class="nav-link active show" id="account-tab"
                                ...
                                aria-selected="true" data-original-title="" title="">{{__('adminNav.wallet_report')}}</a></li>
                    </ul>
                    @if ($errors->count() > 0)
                    {{$errors}}
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form method="GET" action="{{route('admin.wallets-report.request')}}" class="needs-validation user-add">
