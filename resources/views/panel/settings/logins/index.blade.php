            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-details-title">
                        <h3>Total Users are <span>{{$users->count()}}</span> in the selected period</h3>
                    </div>
                </div>
                        ...
                        <table class="all-package coupon-table table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr data-row-id="{{$user->id}}">
                                    ...
                                    <td>{{$user->userable ? $user->userable->name : $user->userable->first_name}}</td>
                                    ...
                                    <td class="list-date">{{$user->login_date}}</td>
                                </tr>
