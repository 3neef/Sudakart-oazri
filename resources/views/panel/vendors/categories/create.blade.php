...
@section('content')
@section('title', __('adminNav.category_requests'))
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                        <li class="nav-item"><a class="nav-link active show" id="account-tab"
                                ...
                                aria-selected="true" data-original-title="" title="">{{__('adminNav.category_requests')}}</a></li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form method="POST" action="{{route('admin.vendors.categories.request.store')}}" class="needs-validation user-add" enctype="multipart/form-data">
                                @csrf
                                <h4>{{__('adminNav.category_requests')}}</h4>
                                <div class="form-group row">
                                    <label for="validationCustom0"
                                        class="col-xl-3 col-md-4"><span>*</span>{{__('adminBody.Category')}}</label>
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom1"
                                        class="col-xl-3 col-md-4"><span>*</span>{{__('body.reason')}}</label>
                                    <div class="col-xl-8 col-md-7">
