            ...
            <div class="card o-hidden widget-cards">
                <div class="secondary-box card-body">
                    <div class="media static-top-widget align-items-center">
                        ...
                        <div class="media-body media-doller"><span class="m-0">{{ __('adminDash.bank_payments') }}</span>
                            <h3 class="mb-0"><span class="counter">{{ $stats->bank_payments }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden widget-cards">
                <div class="secondary-box card-body">
                    <div class="media static-top-widget align-items-center">
                        ...
                        <div class="media-body media-doller"><span class="m-0">{{ __('adminDash.cash_payments') }}</span>
                            <h3 class="mb-0"><span class="counter">{{ $stats->cash_payments }}</span>
                            </div>
                        </div>
                    </div>
                </div>
