...
(function ($) {
    ...
    /*=====================
     ...
     $('#quantity-area .quantity-right-plus').on('click', function () {
    ...
    $('#quantity-area  .quantity-left-minus').on('click', function () {
        var $qty = $('.qty-box .input-number');
        var currentVal = parseInt($qty.val(), 10);
    ...
    $('#bs-prev-btn').on('click',function(){
        $('.product-4').slick('slickPrev');
    });

    $('#bs-next-btn').on('click',function(){
        $('.product-4').slick('slickNext');
    });
