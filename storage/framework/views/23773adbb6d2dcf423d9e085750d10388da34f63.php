        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <form action="<?php echo e(route('admin.order.search')); ?>" method="get" class="search-form" role="search" style="position: relative;">
                        <div class="input-group mb-3">
                            <input type="search" name="q"  placeholder="<?php echo e(__('labels.order_search')); ?>" class="input-group-field" 
                                autocomplete="off"> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/panel/orders/index.blade.php ENDPATH**/ ?>