...
<?php $__env->startSection('title', __('adminBody.update_cate')); ?>
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                        <li class="nav-item"><a class="nav-link active show" id="account-tab"
                                ...
                                aria-selected="true" data-original-title="" title=""><?php echo e(__('adminBody.update_cate')); ?></a></li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form method="POST" action="<?php echo e(route('admin.categories.update', $category->id)); ?>" class="needs-validation user-add" enctype="multipart/form-data">
                                ...
                                <h4><?php echo e(__('adminBody.update_cate')); ?></h4>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\oazri\suda\resources\views/panel/settings/categories/edit.blade.php ENDPATH**/ ?>