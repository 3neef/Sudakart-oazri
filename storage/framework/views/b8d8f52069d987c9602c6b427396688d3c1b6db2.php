                                        ...
                                        <form id="add-to-cart-form-with-option" action="<?php echo e(route('cart.addTocart')); ?>" 
                                                ...
                                                <div id="quantity-area" class="qty-box">
                                                    <div class="input-group"><span class="input-group-prepend">
                                                        ...
                                                        <input type="number" name="quantity" class="form-control input-number" id="input-number"  value="1" min="1" data-qty=""="<?php echo e($product->quantity); ?>">
...
} elseif ($_instance->childHasBeenRendered('YrAj0uN')) {
    $componentId = $_instance->getRenderedChildComponentId('YrAj0uN');
    $componentTag = $_instance->getRenderedChildComponentTagName('YrAj0uN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YrAj0uN');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('YrAj0uN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/main/product/show.blade.php ENDPATH**/ ?>