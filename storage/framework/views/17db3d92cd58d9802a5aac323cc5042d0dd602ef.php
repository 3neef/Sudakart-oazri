...
} elseif ($_instance->childHasBeenRendered('59uU2dC')) {
    $componentId = $_instance->getRenderedChildComponentId('59uU2dC');
    $componentTag = $_instance->getRenderedChildComponentTagName('59uU2dC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('59uU2dC');
} else {
    $response = \Livewire\Livewire::mount('show-check-out');
    $html = $response->html();
    $_instance->logRenderedChild('59uU2dC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/main/checkout/index.blade.php ENDPATH**/ ?>