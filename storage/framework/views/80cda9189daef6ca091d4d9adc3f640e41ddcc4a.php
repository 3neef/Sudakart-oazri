...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('customer.doLogin')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600"><?php echo e(__('body.Remember_me')); ?></span>
                </label>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('password.request')); ?>">
                        <?php echo e(__('body.Forgot_your_password')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/auth/main/login.blade.php ENDPATH**/ ?>