                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.accounting.wallets.operation', $wallet->id)); ?>">
                                            <i class="fa fa-money fa-2x text-success" title="operations"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.accounting.wallets.history', $wallet->id)); ?>">
                                            <i class="fa fa-history fa-2x text-warning" title="history"></i>
                                        </a>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/panel/accounting/wallets.blade.php ENDPATH**/ ?>