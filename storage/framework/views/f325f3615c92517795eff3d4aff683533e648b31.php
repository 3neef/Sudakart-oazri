...
<?php $__env->startSection('title', __('adminBody.new_ad')); ?>
        ...
        <div class="card-body">
            <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                <li class="nav-item"><a class="nav-link active show" id="general-tab"
                        ...
                        aria-selected="true" data-original-title="" title=""><?php echo e(__('adminBody.new_ad')); ?></a></li>
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="general" role="tabpanel"
                    ...
                    <form method="POST" action="<?php echo e(route('admin.ads.store')); ?>" class="needs-validation" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <h4><?php echo e(__('adminBody.new_ad')); ?></h4>
                        <div class="form-group row">
                            <label class="col-xl-3 col-md-4"><span>*</span><?php echo e(__('body.product')); ?></label>
                            <div class="col-md-7">
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\oazri\suda\resources\views/panel/promotions/ads/create.blade.php ENDPATH**/ ?>