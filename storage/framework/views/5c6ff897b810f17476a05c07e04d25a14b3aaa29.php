...
} elseif ($_instance->childHasBeenRendered('I6qppTb')) {
    $componentId = $_instance->getRenderedChildComponentId('I6qppTb');
    $componentTag = $_instance->getRenderedChildComponentTagName('I6qppTb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('I6qppTb');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('I6qppTb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id])->html();
} elseif ($_instance->childHasBeenRendered('IXy06N9')) {
    $componentId = $_instance->getRenderedChildComponentId('IXy06N9');
    $componentTag = $_instance->getRenderedChildComponentTagName('IXy06N9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IXy06N9');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('IXy06N9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id])->html();
} elseif ($_instance->childHasBeenRendered('9a44oiS')) {
    $componentId = $_instance->getRenderedChildComponentId('9a44oiS');
    $componentTag = $_instance->getRenderedChildComponentTagName('9a44oiS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9a44oiS');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('9a44oiS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('u1Qpcpq')) {
    $componentId = $_instance->getRenderedChildComponentId('u1Qpcpq');
    $componentTag = $_instance->getRenderedChildComponentTagName('u1Qpcpq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u1Qpcpq');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $special->product_id,'style' => 'color : white; margin-top:10px;']);
    $html = $response->html();
    $_instance->logRenderedChild('u1Qpcpq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('DsOc6e4')) {
    $componentId = $_instance->getRenderedChildComponentId('DsOc6e4');
    $componentTag = $_instance->getRenderedChildComponentTagName('DsOc6e4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DsOc6e4');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $pro->product_id,'style' => 'color : white; margin-top:10px;']);
    $html = $response->html();
    $_instance->logRenderedChild('DsOc6e4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                          <span class="tooltip-label">Wishlist</span>
...
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\oazri\suda\resources\views/main/main.blade.php ENDPATH**/ ?>