        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                                    <a href="<?php echo e(route('admin.orders.inbound')); ?>">
                    <i class="fa fa-circle"></i>
                    <span><?php echo e(__('adminNav.dashboard')); ?></span>
                    </a>
            </li>
            ...
            <li>
                <a href="<?php echo e(route('admin.orders.inbound')); ?>">
                    <i class="fa fa-circle"></i>
                    <span><?php echo e(__('adminNav.Inbound')); ?></span>
                </a>
            </li>

            <li>
                <a href="<?php echo e(route('admin.orders.outbound')); ?>">
                    <i class="fa fa-circle"></i>
                    <span><?php echo e(__('adminNav.Outbound')); ?></span>
                </a>
            </li>

            <li>
                <a href="<?php echo e(route('admin.orders.scheduled')); ?>">
                    <i class="fa fa-circle"></i>
                    <span><?php echo e(__('adminNav.scheduled')); ?></span>
                </a>
            </li>
...
<!-- Page Sidebar Ends--><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/partials/menu.blade.php ENDPATH**/ ?>