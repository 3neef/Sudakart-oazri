...
} elseif ($_instance->childHasBeenRendered('MjrGreV')) {
    $componentId = $_instance->getRenderedChildComponentId('MjrGreV');
    $componentTag = $_instance->getRenderedChildComponentTagName('MjrGreV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MjrGreV');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('MjrGreV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\oazri\suda\resources\views/main/product/show.blade.php ENDPATH**/ ?>