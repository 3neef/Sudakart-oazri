...
} elseif ($_instance->childHasBeenRendered('BCHigF9')) {
    $componentId = $_instance->getRenderedChildComponentId('BCHigF9');
    $componentTag = $_instance->getRenderedChildComponentTagName('BCHigF9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BCHigF9');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('BCHigF9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\oazri\suda\resources\views/main/category/show.blade.php ENDPATH**/ ?>