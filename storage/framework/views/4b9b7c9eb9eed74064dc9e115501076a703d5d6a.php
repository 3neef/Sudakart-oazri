...
} elseif ($_instance->childHasBeenRendered('TRj2e9G')) {
    $componentId = $_instance->getRenderedChildComponentId('TRj2e9G');
    $componentTag = $_instance->getRenderedChildComponentTagName('TRj2e9G');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TRj2e9G');
} else {
    $response = \Livewire\Livewire::mount('add-to-wishlist', ['product_id' => $result->id]);
    $html = $response->html();
    $_instance->logRenderedChild('TRj2e9G', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('main/layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\10\Desktop\mazin projects\sudakart-latest-2023\resources\views/main/search.blade.php ENDPATH**/ ?>